...
|`slug_field`|Возвращается методом `get_slug_field()`. По умолчанию "slug"|
|`context_object_name`|По умолчанию `None`|
|`slug_url_kwarg`|По умочанию "slug"|
|`pk_url_kwarg`|По умолчанию "pk"|
|`query_pk_and_slug`|По умолчанию `False`|

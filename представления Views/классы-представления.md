...
|метод|описание|
|---|---|
|`get_template_names()`|Возвращает список имен шаблонов для передачи в `response_class`. По умолчанию возвращает список из одного элемента, содержащего `template_name`|
